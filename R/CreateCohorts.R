...
#
# This file is part of ArachneCohortDiagnostics
#
...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "ArachneCohortDiagnostics")
  if (pathToCsv!=""){
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "ArachneCohortDiagnostics")
  #CohortDiagnostics::checkInputFileEncoding(pathToCsv)
